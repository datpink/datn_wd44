...
class BrandController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($brand->products()->exists()) {
            ...
            return redirect()->route('brands.index')
                             ->with('error', 'Không thể xóa thương hiệu này vì nó có sản phẩm liên quan.');
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('brands.trash')
                         ->with('success', 'Thương hiệu đã được khôi phục thành công!');
    }
    ...
    public function forceDelete($id)
    {
        ...
        if ($brand->products()->exists()) {
            ...
            return redirect()->route('brands.trash')
                             ->with('error', 'Không thể xóa cứng thương hiệu này vì nó có sản phẩm liên quan.');
        ...
        return redirect()->route('brands.trash')
                         ->with('success', 'Thương hiệu đã được xóa cứng thành công!');
    }
}