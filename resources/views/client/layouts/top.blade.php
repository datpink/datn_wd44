    ...
    <ul id="menu-top-left-menu" class="kobolg-nav top-bar-menu">
        <li id="menu-item-864" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-864"><a
                class="kobolg-menu-item-title" title="Store Direction" href="#"><span
                    class="icon flaticon-placeholder"></span>Địa chỉ cửa hàng</a></li>
        <li id="menu-item-865" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-865"><a
                class="kobolg-menu-item-title" title="Order Tracking" href="#"><span
                    class="icon flaticon-box"></span>Theo dõi đơn hàng</a></li>
    </ul>
        ...
        <ul class="wpml-menu">
            <li class="menu-item kobolg-dropdown block-language">
                ...
                <ul class="sub-menu">
                    <li class="menu-item">
                        <a href="#">
                            <img src="{{ asset('theme/client/assets/images/it.png') }}" alt="it" width="18" height="12">
                            Italiano
                        </a>
                    </li>
                </ul>
