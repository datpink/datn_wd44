<div class="response-product product-list-owl owl-slick equal-container better-height" 
    ...
    <div class="slide-wrap">
        <img src="{{ asset('theme/client/assets/images/slide11.jpg') }}" alt="image">
    ...
    <div class="slide-wrap">
        <img src="{{ asset('theme/client/assets/images/slide12.jpg') }}" alt="image">
        <div class="slide-info">
            <div class="slide-inner">
                <h5>Best Selling</h5>
    ...
    <div class="slide-wrap">
        <img src="{{ asset('theme/client/assets/images/slide13.jpg') }}" alt="image">
        <div class="slide-info">
            <div class="slide-inner">
