                ...
                <div class="page-main-content">
                    <div class="kobolg">
                        ...
                        <form method="post" class="checkout kobolg-checkout" action="{{ route('vnpay') }}"
                            ...
                            <div class="container" style="width:auto; height:auto; margin-bottom:30px; ">
                                <div class="" style="height:300px;  width: 500px;border-radius: 8px; position:relative; left:60%">
                                    <div class="" style="position:absolute; height:300px; background-color: #E52E06; ">
                                    <h2 class="text-left mb-3" style="height:30px; width: 480px; font-size: 20px; color:white; background-color: #E52E06;"><strong>Mã giảm giá của bạn</strong></h2>
                                    <div class="container" style="margin: 20px 0; height: 230px; overflow-y: auto;">
                                        @if (Auth::check())
                                        ...
                                        <div class="card mb-3 discount-card" style="border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                                            <div class="card-body d-flex flex-column" style="font-size: 12px; padding: 2px; ">
                                                <div class="discount-info" style="flex-grow: 1; font-size: 12px; ">
                                                    <h5>
                                                        <strong>
                                                            <p style="margin-bottom: 1px;margin-left: 20px;">
                                                    ...
                                                    <p style="margin-bottom: 1px;margin-left: 25px;">Đơn Tối Thiểu: <strong>{{ number_format($userPromotion->promotion->min_order_value, 0) }} VND</strong></p>
                                                    <p style="margin-bottom: 1px;margin-left: 25px;">Có hiệu lực đến: <strong>{{ \Carbon\Carbon::parse($userPromotion->promotion->end_date)->format('d/m/Y') }}</strong></p>
                                                </div>
                                                <div class="discount-actions" style="position: absolute; top: 10px; right: 10px;">
                                                    ...
                                                    @else
                                                    <button class="btn btn-outline-primary btn-sm w-auto mt-2 apply-discount" data-promotion-id="{{ $userPromotion->promotion->id }}"
                                                        data-discount="{{ $userPromotion->promotion->discount_value }}"
                                                        data-max-discount="{{ $userPromotion->promotion->max_value }}"
                                                        data-type="{{ $userPromotion->promotion->type }}">Áp Dụng</button>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
