                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="productForm" action="{{ route('products.store') }}" method="POST"
                                ...
                                @csrf
                                <div class="row">
                                    <div class="mb-3 was-validated col-md-6">
                                    ...
                                    <div class="mb-3 was-validated col-md-6">
                                        ...
                                        <input type="file"
                                            ...
                                            name="image_url" onchange="previewImageUrl(event)" required>
                                    ...
                                    <div class="mt-3 ms-5 was-validated col-md-3">
                                        <label for="is_featured" class="form-label">Sản phẩm nổi bật</label> <br>
                                    ...
                                    <div id="image-inputs">
                                        <div class="form-group d-flex align-items-center mb-3">
                                            <label for="image1" class="me-2 col-md-1">Gallery 1</label>
