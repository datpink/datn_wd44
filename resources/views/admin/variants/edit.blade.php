                ...
                <div class="card-body mt-4">
                    ...
                    <form
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" id="product_id" value="{{ $variant->product->name }}"
                                readonly>
                        </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" name="price"
                                id="price" value="{{ old('price', number_format($variant->price, 0, '.', '')) }}"
                                step="0.01" required>
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control @error('stock') is-invalid @enderror" name="stock"
                                id="stock" value="{{ old('stock', $variant->stock) }}" required>
                            @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control @error('sku') is-invalid @enderror" name="sku"
                                id="sku" value="{{ old('sku', $variant->sku) }}" readonly>
                            @error('sku')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
