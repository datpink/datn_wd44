...
<div class="container">
    ...
    <form action="{{ route('discounts.update', $discount->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="discount_value" name="discount_value" value="{{ old('discount_value', $discount->discount_value) }}" required>
        </div>
       ...
       value="{{ old('end_date', \Carbon\Carbon::parse($discount->end_date)->format('Y-m-d')) }}" 
       required>
        </div>
